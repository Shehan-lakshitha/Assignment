...
const SignIn: React.FC = () => {
  ...
  const handleSignIn = async (values: {
    ...
    setLoading(true);
    try {
      const response = await fetch("http://localhost:5068/api/auth/signin", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className=" bg-white font-bold text-[#105cd7] shadow-md flex justify-center p-8 rounded-lg">
